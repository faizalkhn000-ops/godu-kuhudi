...
INSERT INTO categories (id, name, slug, description, sort_order) VALUES
  ('22222222-0000-0000-0000-000000000001', 'Perfumes', 'perfumes', 'Signature eau de parfums crafted to linger', 1),
  ('22222222-0000-0000-0000-000000000002', 'Body Mists', 'body-mists', 'Lightweight fragrance for everyday moments', 2),
  ('22222222-0000-0000-0000-000000000003', 'Body Care', 'body-care', 'Luxurious body care infused with our signature scents', 3),
  ('22222222-0000-0000-0000-000000000004', 'Gift Sets', 'gift-sets', 'Curated collections for unforgettable gifting', 4),
  ('22222222-0000-0000-0000-000000000005', 'Accessories', 'accessories', 'Elegant accessories to complement your fragrance', 5);
...
INSERT INTO product_images (product_id, url, alt_text, sort_order, is_primary) VALUES
  ('11111111-0000-0000-0000-000000000001', '/images/products/velvet-memoir-1.jpg', 'Velvet Memoir Eau de Parfum', 0, true),
  ('11111111-0000-0000-0000-000000000002', '/images/products/midnight-jasmine-1.jpg', 'Midnight Jasmine Eau de Parfum', 0, true),
  ('11111111-0000-0000-0000-000000000003', '/images/products/silk-saffron-1.jpg', 'Silk & Saffron Eau de Parfum', 0, true),
  ('11111111-0000-0000-0000-000000000004', '/images/products/petal-whisper-1.jpg', 'Petal Whisper Eau de Parfum', 0, true),
  ('11111111-0000-0000-0000-000000000005', '/images/products/amber-nocturne-1.jpg', 'Amber Nocturne Eau de Parfum', 0, true),
  ('11111111-0000-0000-0000-000000000006', '/images/products/citrine-breeze-1.jpg', 'Citrine Breeze Eau de Parfum', 0, true),
  ('11111111-0000-0000-0000-000000000007', '/images/products/rosewood-reverie-1.jpg', 'Rosewood Reverie Eau de Parfum', 0, true),
  ('11111111-0000-0000-0000-000000000008', '/images/products/moonlit-oud-1.jpg', 'Moonlit Oud Extrait de Parfum', 0, true),
  ('11111111-0000-0000-0000-000000000009', '/images/products/sunlit-garden-1.jpg', 'Sunlit Garden Body Mist', 0, true),
  ('11111111-0000-0000-0000-000000000010', '/images/products/memory-collection-1.jpg', 'The Memory Collection Gift Set', 0, true);

-- ============================================================================
-- PRODUCT VARIANTS (sizes)
-- ============================================================================
INSERT INTO product_variants (product_id, name, sku, price, compare_at_price, inventory_count, sort_order) VALUES
  ('11111111-0000-0000-0000-000000000001', '30ml', 'KH-VM-001-30', 1499, 1999, 30, 0),
  ('11111111-0000-0000-0000-000000000001', '50ml', 'KH-VM-001-50', 2299, 2999, 25, 1),
  ('11111111-0000-0000-0000-000000000001', '100ml', 'KH-VM-001-100', 2999, 3999, 50, 2),
  ('11111111-0000-0000-0000-000000000002', '50ml', 'KH-MJ-002-50', 2499, NULL, 20, 0),
  ('11111111-0000-0000-0000-000000000002', '100ml', 'KH-MJ-002-100', 3499, NULL, 35, 1),
  ('11111111-0000-0000-0000-000000000003', '50ml', 'KH-SS-003-50', 2799, 3299, 15, 0),
  ('11111111-0000-0000-0000-000000000003', '100ml', 'KH-SS-003-100', 4299, 4999, 25, 1);
